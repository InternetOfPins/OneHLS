proc dump_statistics {  } {
  ...
  file delete -force HLS_output/Synthesis/vivado_flow/oneHlsComplexMacTop_report.xml 
  set ofile_report [open HLS_output/Synthesis/vivado_flow/oneHlsComplexMacTop_report.xml w]
...
create_project oneHlsComplexMacTop -part xc7a100tcsg324-1 -force
read_verilog {oneHlsComplexMacTop.v}
set rfile_sdc [open HLS_output/Synthesis/vivado_flow/oneHlsComplexMacTop.sdc r]
set clk_constraint [regexp -all --  CLK_SRC [read $rfile_sdc [file size HLS_output/Synthesis/vivado_flow/oneHlsComplexMacTop.sdc]]]
if { [expr {$clk_constraint == 0}] } {
  set ofile_sdc [open HLS_output/Synthesis/vivado_flow/oneHlsComplexMacTop.sdc a]
  puts $ofile_sdc "set_property HD.CLK_SRC BUFGCTRL_X0Y0 \[get_ports clock\]"
  close $ofile_sdc
}
read_xdc HLS_output/Synthesis/vivado_flow/oneHlsComplexMacTop.sdc
synth_design -mode out_of_context -no_iobuf -top oneHlsComplexMacTop -part xc7a100tcsg324-1
