proc dump_statistics {  } {
  ...
  file delete -force HLS_output/Synthesis/vivado_flow/oneHlsBiquadTop_report.xml 
  set ofile_report [open HLS_output/Synthesis/vivado_flow/oneHlsBiquadTop_report.xml w]
...
create_project oneHlsBiquadTop -part xc7a100tcsg324-1 -force
read_verilog {oneHlsBiquadTop.v}
set rfile_sdc [open HLS_output/Synthesis/vivado_flow/oneHlsBiquadTop.sdc r]
set clk_constraint [regexp -all --  CLK_SRC [read $rfile_sdc [file size HLS_output/Synthesis/vivado_flow/oneHlsBiquadTop.sdc]]]
if { [expr {$clk_constraint == 0}] } {
  set ofile_sdc [open HLS_output/Synthesis/vivado_flow/oneHlsBiquadTop.sdc a]
  puts $ofile_sdc "set_property HD.CLK_SRC BUFGCTRL_X0Y0 \[get_ports clock\]"
  close $ofile_sdc
}
read_xdc HLS_output/Synthesis/vivado_flow/oneHlsBiquadTop.sdc
synth_design -mode out_of_context -no_iobuf -top oneHlsBiquadTop -part xc7a100tcsg324-1
